...
public class UFO : MonoBehaviour
    ...
    private Vector3 GetNewPositionVector()
        {
        float _xyOffset = 10.0f; // Adjust this value as needed
        float _spawnDistanceFromPlayer = 20.0f; // Adjust this value as needed
        GameObject playerObject = GameObject.Find("Player");
        ...
        // Calculate Z coordinate based on the player's position
        float newZ = _player.position.z + _spawnDistanceFromPlayer;
